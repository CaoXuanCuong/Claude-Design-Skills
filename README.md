...
|-------|----------|-------|--------|-----------|
| **/sync-design-system** | "sync polaris lên claude design", "DS cho app mới", "re-sync DS", "dựng render bundle local" | DS repo path / package name (đúng version của app) | DS bundle trên project + `_ds_bundle.js` (`window.<Global>`); local render bundle để verify | Codebase của UI Components (VD: https://github.com/shopify/polaris-react) |
...
| Tình huống | Skill |
|---|---|
| Đưa 1 custom component/page code lên gallery | `/component-ui-to-design` |
